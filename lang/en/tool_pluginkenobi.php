...
$string['setplugintype'] = 'Plugin type';
$string['setname'] = 'Plugin name';
$string['setversion'] = 'Plugin version';
$string['setrequires'] = 'Required Moodle version';
$string['setmaturity'] = 'Plugin maturity';
$string['setrelease'] = 'Plugin release version';
