...
/**
 * File containing tests for the install_generator class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_pluginkenobi_install_generator_testcase extends advanced_testcase {

    /** @var string[] Basic recipe. */
    protected static $baserecipe = array(
        'component' => 'installgeneratortest',
        'name'      => 'install_generator test',
        'year'      => '2016',
        'author'    => array(
    ...
    public static function setUpBeforeClass() {
        ...
        self::$fixtures = $CFG->dirroot . '/admin/tool/pluginkenobi/tests/fixtures/install_generator';
    }
    ...
    public function test_generate_files() {
        ...
        $generator = new tool_pluginkenobi_install_generator($recipe, $targetdir);
        $generator->generate_files();

        $installfile = $targetdir . '/installgeneratortest/db/install.php';
